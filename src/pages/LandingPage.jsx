...
function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFEE9F] flex flex-col items-center px-6 pt-16"
     style={{ backgroundImage: `url(${scattered_icons})`}}>

      <h1 className="text-4xl font-bold font-roboto text-black mb-6 mt-30 text-center">
